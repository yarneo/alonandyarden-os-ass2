...
main(int argc, char *argv[])
{
  ...
  13:	c7 44 24 04 0c 0c 00 	movl   $0xc0c,0x4(%esp)
  1a:	00 
  ...
  5a:	c7 44 24 04 1f 0c 00 	movl   $0xc1f,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	f7 f7                	div    %edi
 3cc:	0f b6 92 3a 0c 00 00 	movzbl 0xc3a(%edx),%edx
...
putc(int fd, char c)
{
 ...
 640:	e9 30 fe ff ff       	jmp    475 <printf+0x35>
				...
				ap++;
				if(s == 0)
 645:	bf 33 0c 00 00       	mov    $0xc33,%edi
...
free(void *ap)
{
 ...
 651:	a1 04 0d 00 00       	mov    0xd04,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 69f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a1:	a3 04 0d 00 00       	mov    %eax,0xd04
}
 6a6:	5b                   	pop    %ebx
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 ...
 6cb:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 04 0d 00 00       	mov    %eax,0xd04
}
 6d2:	5b                   	pop    %ebx
 6d3:	5e                   	pop    %esi
 6d4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6ec:	8b 0d 04 0d 00 00    	mov    0xd04,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 714:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 718:	3b 05 04 0d 00 00    	cmp    0xd04,%eax
 ...
 737:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 73a:	89 0d 04 0d 00 00    	mov    %ecx,0xd04
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 77c:	e8 cf fe ff ff       	call   650 <free>
  return freep;
 781:	8b 0d 04 0d 00 00    	mov    0xd04,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 794:	eb a4                	jmp    73a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 04 0d 00 00 fc 	movl   $0xcfc,0xd04
 79d:	0c 00 00 
    base.s.size = 0;
 7a0:	b9 fc 0c 00 00       	mov    $0xcfc,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a5:	c7 05 fc 0c 00 00 fc 	movl   $0xcfc,0xcfc
 7ac:	0c 00 00 
    base.s.size = 0;
 7af:	c7 05 00 0d 00 00 00 	movl   $0x0,0xd00
 7b6:	00 00 00 
...
00000950 <semaphore_create>:
 ...
 9a8:	c7 44 24 04 4c 0c 00 	movl   $0xc4c,0x4(%esp)
 9af:	00 
 ...
 a4f:	eb d7                	jmp    a28 <semaphore_pop+0x48>
{
	...
	if(bb->buffer[bb->consume] == 0) {
		printf(2,"something went wrong! buffer is empty and we are trying to consume\n");
 a51:	c7 44 24 04 74 0c 00 	movl   $0xc74,0x4(%esp)
 a58:	00 
...
void semaphore_put_atomic(struct BB* bb, void* element)
{
 ...
 aa2:	c7 44 24 04 b8 0c 00 	movl   $0xcb8,0x4(%esp)
 aa9:	00 
...
void semaphore_put(struct BB* bb, void* element)
{
 ...
 b20:	74 36                	je     b58 <semaphore_put+0x68>
		printf(2,"something went wrong! buffer is full and we are trying to produce\n");
 b22:	c7 44 24 04 b8 0c 00 	movl   $0xcb8,0x4(%esp)
 b29:	00 
