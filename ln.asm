...
main(int argc, char *argv[])
{
  ...
  13:	c7 44 24 04 5c 0c 00 	movl   $0xc5c,0x4(%esp)
  1a:	00 
  ...
  5a:	c7 44 24 04 6f 0c 00 	movl   $0xc6f,0x4(%esp)
  61:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	f7 f7                	div    %edi
 3cc:	0f b6 92 8a 0c 00 00 	movzbl 0xc8a(%edx),%edx
...
putc(int fd, char c)
{
 ...
 640:	e9 30 fe ff ff       	jmp    475 <printf+0x35>
				...
				ap++;
				if(s == 0)
 645:	bf 83 0c 00 00       	mov    $0xc83,%edi
...
free(void *ap)
{
 ...
 651:	a1 54 0d 00 00       	mov    0xd54,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 69f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a1:	a3 54 0d 00 00       	mov    %eax,0xd54
}
 6a6:	5b                   	pop    %ebx
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 ...
 6cb:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 54 0d 00 00       	mov    %eax,0xd54
}
 6d2:	5b                   	pop    %ebx
 6d3:	5e                   	pop    %esi
 6d4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6ec:	8b 0d 54 0d 00 00    	mov    0xd54,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 714:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 718:	3b 05 54 0d 00 00    	cmp    0xd54,%eax
 ...
 737:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 73a:	89 0d 54 0d 00 00    	mov    %ecx,0xd54
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 77c:	e8 cf fe ff ff       	call   650 <free>
  return freep;
 781:	8b 0d 54 0d 00 00    	mov    0xd54,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 794:	eb a4                	jmp    73a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 54 0d 00 00 4c 	movl   $0xd4c,0xd54
 79d:	0d 00 00 
    base.s.size = 0;
 7a0:	b9 4c 0d 00 00       	mov    $0xd4c,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a5:	c7 05 4c 0d 00 00 4c 	movl   $0xd4c,0xd4c
 7ac:	0d 00 00 
    base.s.size = 0;
 7af:	c7 05 50 0d 00 00 00 	movl   $0x0,0xd50
 7b6:	00 00 00 
 ...
 9a4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
{
	...
	if(((ret->S1 = binary_sem_create()) + (ret->S2 = binary_sem_create())) < 0) {
		printf(2,"couldnt create the 2 binary semaphores");
 9a8:	c7 44 24 04 9c 0c 00 	movl   $0xc9c,0x4(%esp)
 9af:	00 
 ...
 a9f:	eb d7                	jmp    a78 <semaphore_pop+0x48>
{
	...
	if(bb->buffer[bb->consume] == 0) {
		printf(2,"something went wrong! buffer is empty and we are trying to consume\n");
 aa1:	c7 44 24 04 c4 0c 00 	movl   $0xcc4,0x4(%esp)
 aa8:	00 
...
void semaphore_put_atomic(struct BB* bb, void* element)
{
 ...
 af2:	c7 44 24 04 08 0d 00 	movl   $0xd08,0x4(%esp)
 af9:	00 
...
void semaphore_put(struct BB* bb, void* element)
{
 ...
 b70:	74 36                	je     ba8 <semaphore_put+0x68>
		printf(2,"something went wrong! buffer is full and we are trying to produce\n");
 b72:	c7 44 24 04 08 0d 00 	movl   $0xd08,0x4(%esp)
 b79:	00 
