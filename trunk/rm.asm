...
main(int argc, char *argv[])
{
  ...
  42:	c7 44 24 04 20 0c 00 	movl   $0xc20,0x4(%esp)
  49:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    printf(2, "Usage: rm files...\n");
  60:	c7 44 24 04 0c 0c 00 	movl   $0xc0c,0x4(%esp)
  67:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ca:	f7 f7                	div    %edi
 3cc:	0f b6 92 40 0c 00 00 	movzbl 0xc40(%edx),%edx
...
putc(int fd, char c)
{
 ...
 640:	e9 30 fe ff ff       	jmp    475 <printf+0x35>
				...
				ap++;
				if(s == 0)
 645:	bf 39 0c 00 00       	mov    $0xc39,%edi
...
free(void *ap)
{
 ...
 651:	a1 0c 0d 00 00       	mov    0xd0c,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 69f:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6a1:	a3 0c 0d 00 00       	mov    %eax,0xd0c
}
 6a6:	5b                   	pop    %ebx
 6a7:	5e                   	pop    %esi
 6a8:	5f                   	pop    %edi
 ...
 6cb:	89 10                	mov    %edx,(%eax)
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 0c 0d 00 00       	mov    %eax,0xd0c
}
 6d2:	5b                   	pop    %ebx
 6d3:	5e                   	pop    %esi
 6d4:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6e9:	8b 5d 08             	mov    0x8(%ebp),%ebx
  if((prevp = freep) == 0){
 6ec:	8b 0d 0c 0d 00 00    	mov    0xd0c,%ecx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 714:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    if(p == freep)
 718:	3b 05 0c 0d 00 00    	cmp    0xd0c,%eax
 ...
 737:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 73a:	89 0d 0c 0d 00 00    	mov    %ecx,0xd0c
      return (void*) (p + 1);
...
morecore(uint nu)
{
 ...
 77c:	e8 cf fe ff ff       	call   650 <free>
  return freep;
 781:	8b 0d 0c 0d 00 00    	mov    0xd0c,%ecx
      }
      freep = prevp;
      return (void*) (p + 1);
    }
 ...
 794:	eb a4                	jmp    73a <malloc+0x5a>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 0c 0d 00 00 04 	movl   $0xd04,0xd0c
 79d:	0d 00 00 
    base.s.size = 0;
 7a0:	b9 04 0d 00 00       	mov    $0xd04,%ecx
  Header *p, *prevp;
  uint nunits;
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7a5:	c7 05 04 0d 00 00 04 	movl   $0xd04,0xd04
 7ac:	0d 00 00 
    base.s.size = 0;
 7af:	c7 05 08 0d 00 00 00 	movl   $0x0,0xd08
 7b6:	00 00 00 
...
00000950 <semaphore_create>:
 ...
 9a8:	c7 44 24 04 54 0c 00 	movl   $0xc54,0x4(%esp)
 9af:	00 
 ...
 a4f:	eb d7                	jmp    a28 <semaphore_pop+0x48>
{
	...
	if(bb->buffer[bb->consume] == 0) {
		printf(2,"something went wrong! buffer is empty and we are trying to consume\n");
 a51:	c7 44 24 04 7c 0c 00 	movl   $0xc7c,0x4(%esp)
 a58:	00 
...
void semaphore_put_atomic(struct BB* bb, void* element)
{
 ...
 aa2:	c7 44 24 04 c0 0c 00 	movl   $0xcc0,0x4(%esp)
 aa9:	00 
...
void semaphore_put(struct BB* bb, void* element)
{
 ...
 b20:	74 36                	je     b58 <semaphore_put+0x68>
		printf(2,"something went wrong! buffer is full and we are trying to produce\n");
 b22:	c7 44 24 04 c0 0c 00 	movl   $0xcc0,0x4(%esp)
 b29:	00 
